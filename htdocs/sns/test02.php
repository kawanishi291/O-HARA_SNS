        ...
        <nav>
          ...
          <h1>class-member</h1><ul class="link">
                <?php
                    ...
                    $sql = "SELECT user_id, user_name, user_img FROM users WHERE user_id != {$_SESSION['user_id']} AND class = {$_SESSION['class']}";
                    $stmt = $pdo -> query($sql);
...
<!--                <form method="post" action="browse-chat.php">-->
        ...
        <button class="btn" onclick="location.href='./test02.php'">更新</button>
